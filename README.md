...
If you encounter bugs, rendering issues, or have feature proposals, please feel free to open a [GitHub Issue](https://github.com/Hakim-Fan/sidedock/issues). The **SideDock Team** actively reviews community feedback and iterates frequently!
...
If you run into glitches, rendering issues, or application crashes, please open a [New Issue](https://github.com/Hakim-Fan/sidedock/issues) and provide:
